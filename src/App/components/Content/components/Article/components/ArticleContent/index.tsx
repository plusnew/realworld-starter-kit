...
import type articleRoute from "../../";
import { getArticle } from "shared/api/request";

export default component(
  __dirname,
  (Props: Props<{ parameter: RouteToParameter<typeof articleRoute> }>) => (
    <Props>
      {(props) => (
        <Async
          ...
          constructor={() =>
            getArticle({
              slug: props.parameter.article.slug,
            })
          }
        >
